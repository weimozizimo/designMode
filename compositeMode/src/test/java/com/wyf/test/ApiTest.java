...
import com.wyf.service.engine.impl.TreeEngineHandler;
...
public class ApiTest {
    ...
    public void test_tree(){
        ...
        EngineResult result = treeEngineHandler.process(10001L, "wodijwd", treeRich, decisionMatter);
    ...
    public void testMapper(){
        ...
        decisionTree.setTreeName("tree1")
                .setRemark("测试树")
                .setRootNodeId(0)
                .setCreateTime(new Date())
                .setUpdateTime(new Date());

        decisionTreeService.save(decisionTree);
    }

    @Test
    public void testSelect(){
        List<DecisionTree> list = decisionTreeService.list();
